...
public class SpecParser {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final InputStream fixSpec = Util.getFileOnClasspath(specLocationOnClasspath);
        (new SpecParser()).parseSpec(fixSpec, packageName);
    }

    public void parseSpec(final InputStream spec, final String packageName) throws Exception {
        final Node xmlRoot = new XmlParser().parse(spec);
